...
public final class ConstSQL {
    ...
    public static final String JDBC_CONNECTION = "jdbc:postgresql://localhost:5433/lesson_db";
    /** ユーザー名 */
    ...
    // FIXME Step-2-1: [SQL-SELECT]
    // 社員情報テーブルより、作成日時、更新日時、削除フラグを除いたカラムを取得するクエリを作成しなさい。
